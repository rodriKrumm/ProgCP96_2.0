...
namespace PROGCP96_V1._1_
{
    public partial class VisorCLP_CONTADOR : Form
    {
        ...
        private void VisorCLP_CONTADOR_Shown(object sender, EventArgs e)
        {
            for (int i = 0; i < 32; i++)
            {
                vetorvazio[i] = ' ';
            ...
            vetorMensagem = CONTADOR.passarMsg; // vetor que recebe a mensagem do display 
            ...
            lb_27.Text = CONTADOR.mostrar1.ToString();
            lb_28.Text = CONTADOR.mostrar2.ToString();
            lb_29.Text = CONTADOR.mostrar3.ToString();
            lb_30.Text = CONTADOR.mostrar4.ToString();
            lb_31.Text = CONTADOR.mostrar5.ToString();
            CONTADOR.mostrar7 = ' ';
            CONTADOR.mostrar6 = ' ';
        }

        private void VisorCLP_CONTADOR_Load(object sender, EventArgs e)
        {
