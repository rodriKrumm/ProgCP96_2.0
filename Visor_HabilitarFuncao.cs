...
{
    public partial class Visor_HabilitarFuncao : Form
    {

        public static string receberMsg;
        public static char[] vetorvazio = new char[32];
        public static char[] vetorMensagem;
        public Visor_HabilitarFuncao()
        {
            InitializeComponent();
        }

        private void Visor_HabilitarFuncao_Load(object sender, EventArgs e)
        {

        }

        private void Visor_HabilitarFuncao_Shown(object sender, EventArgs e)
        {
            for (int i = 0; i < 32; i++)
            {
                vetorvazio[i] = ' ';
            ...
            vetorMensagem = Habilitar_Funcoes.passarMsg; // vetor que recebe a mensagem do display 
