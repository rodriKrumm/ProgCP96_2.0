...
{
    public partial class MENSAGEM_DISPLAY2 : Form
    {
        ...
        public MENSAGEM_DISPLAY2()
        {
            InitializeComponent();
        }

        private void MENSAGEM_DISPLAY2_Load(object sender, EventArgs e)
        {

        }

        private void MENSAGEM_DISPLAY2_Shown(object sender, EventArgs e)
        {
            vetRecebe = AUXILIAR_ANALOGICA.repassarMsg;
            for (int i = 0; i < 16; i++)
            {
                vetorVazio[i] = ' ';
            }
